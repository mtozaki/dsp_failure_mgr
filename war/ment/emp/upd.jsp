...
<html xml:lang="ja" lang="ja" dir="ltr">
	...
	<body>
		...
		<div id="container">
			<form name="form1" method="POST" action="/ment/emp/upd" id="config">
				<input type="hidden" ${f:hidden("key")}/>
				<ul class="formBox">
					<li>
						<label class="labelTitle">社員No.</label>
						<div class="labelData"><input type="text" class="text" id="empNo" maxlength="6" ${f:text("empNo")}></div>
					</li>
					<li>
						<label class="labelTitle">社員名</label>
						<div class="labelData"><input type="text" class="text" id="empName" maxlength="10" ${f:text("empName")}></div>
					</li>
				</ul>
				<ul class="buttonBox">
