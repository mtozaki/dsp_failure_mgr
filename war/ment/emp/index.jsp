...
<c:forEach var="head" items="${empList}" varStatus="hs" >
					<li>
						...
						<div class="labelData">[${f:h(head.empNo)}]&nbsp;&nbsp;${f:h(head.empName)}</div>
					</li>
</c:forEach>
				</ul>
				<ul class="buttonBox">
					<li><input value="社員登録" class="button post" type="button" onclick="location.href='add'"></li>
				</ul>
			</form>
		</div>
