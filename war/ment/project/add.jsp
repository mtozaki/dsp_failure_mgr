...
<html xml:lang="ja" lang="ja" dir="ltr">
	...
	<body>
		...
		<div id="container">
			<form name="form1" method="POST" action="/ment/project/add" id="config">
				<ul class="formBox">
					<li>
						<label class="labelTitle">案件No.</label>
						<div class="labelData"><input value="" type="text" name="pjNo" class="text" id="pjNo" maxlength="6"></div>
					</li>
					<li>
						<label class="labelTitle">案件名</label>
						<div class="labelData"><input type="text" name="pjName" class="text" id="pjName" maxlength="10"></div>
					</li>
				</ul>
				<ul class="buttonBox">
