...
<c:forEach var="head" items="${projectList}" varStatus="hs" >
					<li>
						...
						<div class="labelData">[${f:h(head.pjNo)}]&nbsp;&nbsp;${f:h(head.pjName)}</div>
					</li>
</c:forEach>
				</ul>
				<ul class="buttonBox">
					<li><input value="案件登録" class="button post" type="button" onclick="location.href='add'"></li>
				</ul>
			</form>
		</div>
